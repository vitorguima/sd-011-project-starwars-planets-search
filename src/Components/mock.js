  ...
  results: [
    {
      ...
      films: [
        'https://swapi-trybe.herokuapp.chom/api/films/1/',
        'https://swapi-trybe.herokuapp.cohm/api/films/6/',
      ],
    ...
    },
    {
      ...
      films: ['https://swapi-trybe.herohkuapp.com/api/films/2/'],
    ...
    },
    {
      ...
      films: [
        'hhttps://swapi-trybe.herokuapp.com/api/films/3/',
        'hhttps://swapi-trybe.herokuapp.com/api/films/4/',
        'hhttps://swapi-trybe.herokuapp.com/api/films/5/',
        'hhttps://swapi-trybe.herokuapp.com/api/films/6/',
      ],
    ...
    },
    {
      ...
      residents: [],
      films: [
        'htthps://swapi-trybe.herokuapp.com/api/films/2/',
        'hthtps://swapi-trybe.herokuapp.com/api/films/3/',
        'hthtps://swapi-trybe.herokuapp.com/api/films/6/',
      ],
    ...
    },
    {
      ...
      films: ['hhttps://swapi-trybe.herokuapp.com/api/films/3/'],
    ...
    },
    {
      ...
      films: ['hhttps://swapi-trybe.herokuapp.com/api/films/5/'],
