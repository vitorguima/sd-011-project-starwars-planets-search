...
Aqui você vai encontrar os detalhes de como estruturar o desenvolvimento do seu projeto a partir deste repositório, utilizando uma branch específica e um _Pull Request_ para colocar seus códigos =Ds
...
Link: [Avaliação](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_name=Turma%2011)
